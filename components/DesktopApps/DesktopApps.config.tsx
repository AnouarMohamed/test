...
import { portfolioPageTitle, siteProfile } from '../../config/siteProfile';
...
export const useDesktopApps = (): {
  ...
  const initialDesktopAppsList: IDesktopApp[] = [
    ...
    },
    {
      ...
      willOpenWindowWith: null,
      variant: 'desktop',
      iconSrc: '/assets/icons/Desktop/chess-com.svg',
      iconSize: { width: 40, height: 40 },
      action: () => openExternalLink('https://www.chess.com/member/nattrammn'),
    },
    {
      id: 9,
      text: 'Spotify',
      willOpenWindowWith: null,
      variant: 'desktop',
      iconSrc: '/assets/icons/Desktop/spotify.svg',
      iconSize: { width: 40, height: 40 },
      action: () =>
        openExternalLink(
          'https://open.spotify.com/user/31jnd7m4ugz32al7tbheyevsttva?si=7429220338684aa1'
        ),
    },
    {
      id: 10,
